...
public class FindAllProductsFilteredUseCaseImpl implements FindAllProductsFilteredUseCase {
    ...
    @Override
    @Transactional
    public Page<Product> execute(Long categoryId, Boolean active, String name, Pageable pageable) {
        return productRepository.findAllFiltered(categoryId,active,name,pageable);
    }
}
